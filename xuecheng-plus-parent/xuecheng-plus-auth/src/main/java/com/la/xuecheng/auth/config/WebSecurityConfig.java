...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public UserDetailsService userDetailsService() {
        ...
        manager.createUser(User.withUsername("liao").password("123456").authorities("p1").build());
        manager.createUser(User.withUsername("zqy").password("123456").authorities("p2").build());
        return manager;
    }*/
